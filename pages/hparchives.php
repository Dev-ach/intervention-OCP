        ...
        <div class="col s12 m12 ">
            <div class="card">
              <div class="card-content">
                ...
                <h6 class="grey-text">Valider par <?=$post->hpedit?> le <?=date("d/m/Y",strtotime($post->hpdate)); ?></h6>
              ...
              <div class="card-action">
                  ...
                  <center><a style="color:green;" href="index.php?page=hpinterarch&id=<?=$post->id?>">Voir demande</a></center>
              </div>
            </div>
        </div>
<?php
